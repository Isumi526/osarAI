-- おさらい対話で判明した内容(custom_fields=商品/年齢/性別 と points/needs/next_actions)を、
-- セッション単位でターンをまたいで累積するための列。追加のみ（既存データ・既存挙動に影響なし）。
-- 形: {"custom_fields": {...}, "points": [...], "needs": [...], "next_actions": [...]}
--
